...
def testOnePatientGetPlots(patient,sop, number_features,total_seizures,c_value):
    ...
    ###################### Classification #######################
    firing_power_all_classifiers_smooth=[]
    for i in range(0,len(testing_labels)):
        seizure_smooth=[]
        for j in range(0,number_of_classifiers):
            seizure_smooth.append(utils.SmoothOutput(predicted_labels_each_classifier[j][i],sop,window_length))    
        firing_power_all_classifiers_smooth.append(seizure_smooth)
    ...
    return [testing_datetimes, testing_onsets, testing_labels,
            predicted_labels,firing_power_smooth, firing_power_all_classifiers_smooth,
            features_names_each_classifier]
